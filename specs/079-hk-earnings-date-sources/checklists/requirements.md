...
- specify 期 3 个澄清项已由 owner 裁决并写入 `## Clarifications` Session（二）：公布日为准 + 单一公布日与取值口径优先级（FR-008 / FR-009 / FR-010 / FR-014）、美股进合并层且状态为「确认状态未知」（FR-002 / FR-021）、覆盖全部港股（FR-024）；腾讯源不接入。
