...
> ⚠️ 本表由脚本枚举 spec 的 `state_branches`（28）/ FR（30）/ SC（14）/ Edge Case（17）/ Acceptance Scenario（13）后逐条对照写成；**本表这次对了，不构成它下次仍对的证据** —— analyze 前先重跑枚举。
>
