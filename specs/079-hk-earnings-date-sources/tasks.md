...
>
> 📌 **2026-09-14 T017 / T018 前置修正（不翻任何 task 行）**：F1 已通知日期未知只认公布日 ≥ 通知刊发日的未刊发事件（T005 / T014；原判据「任一未刊发带日期事件」会被期间空白 `D:` 键的长期逾期事件永久挡住，FR-017 静默漏报）。
