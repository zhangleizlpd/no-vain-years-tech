...
| US3-AS2 | 收租意图 + 建仓 Tab → 标按收租档带打，非建仓带   | T006 · **T009**                    |
...
| 13  | 收租意图 + 建仓 Tab → 标按收租档带（配就地说明）   | T006 · T009                                          |
...
| 收租意图下建仓 Tab 的标按收租带打（长得跟用错带一样）            | T006 · **T009**                           |
...
| SC-005 收租意图下按建仓带打的标恒 0 / 待定全表恒 0        | T006 · **T009**                                             |
