...
- [AI Friction Catalog · F-006 Indirect-Spec-Module-Mapping](../improvements/2026-05/05-21-ai-friction-catalog-v1.md#f-006--indirect-spec-module-mapping) — ADR `applies_to` + programmatic filter 缓解 LLM 上下文噪声
