...
describe('015 marketdata schema migration (Testcontainers PG migrate deploy)', () => {
  ...
  it('34 张 marketdata 表全部落库 (015 6 事实表 + 016 3 同步配置/审计表 + 017 依赖边表 + 019 因子表 + 039 5 量化信号表 + 040 volatility/hot 2 表 + 041 4 事件流表 + 042 3 报告期表 + 043 2 分类文本表 + 044 日历心跳表 + 046 标的级 IV 2 表 + 046 美股指数日线表 + 047 链合约/逐日快照/财报日历 3 表)', async () => {
