...
export const OPTIONSDESK_COPY = {
  ...
  legPicker: {
     ...
     */
    tierDegradeOverCap:
      '本次候选范围内合约过多，超出单批取价上限 —— 整表回落收盘档，可收窄条件后重试',
    tierDegradeBasisStale: '标的盘中价未按时更新，定不出取价范围 —— 屏上是收盘盘口',
    /**
