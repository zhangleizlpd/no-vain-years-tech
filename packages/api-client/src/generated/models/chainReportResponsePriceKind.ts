 ...
 */
export type ChainReportResponsePriceKind = typeof ChainReportResponsePriceKind[keyof typeof ChainReportResponsePriceKind];


export const ChainReportResponsePriceKind = {
  eod_close: 'eod_close',
  realtime: 'realtime',
} as const;
