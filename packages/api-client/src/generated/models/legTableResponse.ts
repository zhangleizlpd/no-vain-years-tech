...
export interface LegTableResponse {
  ...
  /** 本轮候选码数超**供应方单批上限**, 被按行权价档裁掉多少条 —— 这些腿本轮**未去问实时价** (077 FR-007); 未裁剪恒 0。🚨 **与 candidateCapDropped 同族的保险丝** ⇒ 同样蓄意不进 gateCounts: 那两个数答「判据挡下了什么」, 本数答「供应方一次只让问这么多」, 两者处置完全不同。EVIDENCE: 上限取值单点 marketdata/option-snapshot.port.ts:95 */
